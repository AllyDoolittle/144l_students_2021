...
```{r echo=FALSE, fig.height=8, fig.width=6, message=FALSE, warning=FALSE, paged.print=FALSE,results='hide'}
ln_cells %>%
  mutate(dna = ifelse(DNA_Sample == T, "*", NA)) %>%
...
```{r fig.height=5, fig.width=8, message=FALSE, warning=FALSE, paged.print=FALSE, echo=FALSE,results='hide'}
